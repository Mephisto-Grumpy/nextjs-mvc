  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div className="flex flex-row gap-8 items-center justify-center mt-8">
        <Link
          href="/login"
          className="group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-zinc-300 hover:bg-zinc-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30"
        >
